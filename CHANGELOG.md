...
## [0.1.0](https://github.com/USThing/template-api/compare/v0.2.5...v0.1.0) (2026-05-01)


### Features

* add common fastify plugins ([096d1be](https://github.com/USThing/template-api/commit/096d1be31bce62a217aa3f9ce809a4fa8751b567))
* api monitoring ([#49](https://github.com/USThing/template-api/issues/49)) ([0a91da7](https://github.com/USThing/template-api/commit/0a91da77f48582e7dc4b155120d292228d6a0819))
...
* **auth:** refactor authentication plugin ([#103](https://github.com/USThing/template-api/issues/103)) ([0d39e87](https://github.com/USThing/template-api/commit/0d39e874b3d640ea141928296208080728336a8d))
...
* **auth:** support v1.0 and v2.0 tokens ([fb70c59](https://github.com/USThing/template-api/commit/fb70c591def5504044b9db0241d98ebe02ff0441))
...
* **typebox:** `kind` is non-enumerable ([#82](https://github.com/USThing/template-api/issues/82)) ([ec13fba](https://github.com/USThing/template-api/commit/ec13fbaa4564d3aa8cf7cb26ed9c395236ef9b47))
* **typebox:** update and add `CorrectiveParse` pipeline ([#85](https://github.com/USThing/template-api/issues/85)) ([35b2c03](https://github.com/USThing/template-api/commit/35b2c0305efe71fbb74a1ecd299b433428352c25))
